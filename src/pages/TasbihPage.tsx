  ...
  return (
    <>
      <div className="flex flex-col items-center h-full px-5 pt-8 pb-4">
        ...
        <button
          onClick={handleTap}
          className={`relative w-64 h-64 rounded-full flex items-center justify-center text-white font-bold text-2xl tracking-wider uppercase transition-transform active:scale-95 ${
            isComplete
